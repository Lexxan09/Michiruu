...
# ORANGE tidak ada di Fore, pakai YELLOW / LIGHTYELLOW
...
def color_print(*args, **kwargs):
    ...
    _original_print(f"{ORANGE}{text}{Style.RESET_ALL}", **kwargs)
...
def show_main_menu(profile):
    ...
    print(f"Number: {profile['number']} | Type: {profile['subscription_type']}".center(WIDTH))
    print(f"Balance: Rp {profile['balance']} | Active: {expired_at_dt}".center(WIDTH))
    print(f"{profile['point_info']}".center(WIDTH))
    print("=" * WIDTH)
    print("Menu:")
    print("1. Account Manager")
    print("2. My Package")
    print("3. Avaible Package")
    print("4. Avaible Package 2")
    print("5. Search Using Option Code")
    print("6. Search Using Family Code")
    print("7. Buy Aall Family Code (loop)")
